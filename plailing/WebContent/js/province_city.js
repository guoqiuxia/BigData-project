var cities = [
    ...
    ['石家庄', '邢台', '邯郸', '唐山', '秦皇岛','张家口','保定','承德','沧州','廊坊','衡水'],
    ['太原市','大同市','阳泉市','长治市','晋城市','朔州市','晋中市','运城市','忻州市','临汾市','吕梁市'],
    ['呼和浩特市','包头市','乌海市','赤峰市','通辽市','鄂尔多斯市','呼伦贝尔市','巴彦淖尔市','乌兰察布市','兴安盟','锡林郭勒盟','阿拉善盟'],
    ['沈阳市','大连市','鞍山市','抚顺市','本溪市','丹东市','锦州市','营口市','阜新市','辽阳市','盘锦市','铁岭市','朝阳市','葫芦岛市'],
    ['长春市','吉林市','四平市','辽源市','通化市','白山市','松原市','白城市','延边朝鲜族自治州'],
    ['哈尔滨市','齐齐哈尔市','鸡西市','鹤岗市','双鸭山市','大庆市','伊春市','佳木斯市','七台河市','牡丹江市','黑河市','绥化市','大兴安岭地区'],
    ['黄浦区','卢湾区','徐汇区','长宁区','静安区','普陀区','闸北区','虹口区','杨浦区','闵行区','宝山区','嘉定区','浦东新区','金山区','松江区','青浦区','南汇区','奉贤区','崇明'],
    ...
    ['台北市','高雄市','台中市','新北市','基隆市'],
    ['荃湾区','湾仔区','东区','南区'	,'油尖旺区','深水埗区','九龙城区','中西区','观塘区','离岛区','屯门区','元朗区','北区','大埔区','西贡区','沙田区','葵青区','黄大仙区'],
    ['花地玛堂区','圣安多尼堂区','大堂区','望德堂区','风顺堂区','嘉模堂区','圣方济各堂区'],

//new Option(text, value, defaultSelected, selected);
//第一个TRUE是(默认被选项，即焦点的在项，只有一个)defaultselected，相当于  <option   selected></option>  
//第二个TRUE是被选择项（可多行被选择），用于multip
...
provinceSel.onchange = function () {
    ...
    for (var i = 0; i < cities[provinceSel.value].length; i++) {
        ...
        // cityOpt.innerText = cities[provinceSel.value][i];
        // cityOpt.value = i;
        // citySel.appendChild(cityOpt);
        citySel.add(new Option(cities[provinceSel.value][i], i));
    }
};