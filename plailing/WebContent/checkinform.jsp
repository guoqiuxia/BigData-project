	...
	<div class="subbox">
		...
		<div class="right840">
			<div class="title6">
				...
				<h1>
					<a href="${ctx }/release" class="on">审核通知</a>
				</h1>
				<h1>
			...
			<div class="display">
				<div>
				<c:forEach var="inform" items="${listInform}">
					<p>
						<a href="${ctx }/upload"><span style="color: #333; font-size: 16px;">${inform.informText}</span></a>
					</p>
				</c:forEach>
				</div>
				<div class="pagination-container pagemiddle">
					<span class="wordstyle disabled">共${pageRelease.totalPageNum}页</span>&nbsp;&nbsp;&nbsp;
					<a class="wordstyle disabled" href="${ctx }/release?pageNum=1">首页</a> &nbsp;&nbsp;&nbsp;<a class="wordstyle disabled"
						href="${ctx }/release?pageNum=${pageRelease.prePageNum }">上一页</a>&nbsp;&nbsp;&nbsp; <a class="wordstyle disabled"
						href="${ctx }/release?pageNum=${pageRelease.nextPageNum }">下一页</a> &nbsp;&nbsp;&nbsp;<a class="wordstyle disabled"
						href="${ctx }/release?pageNum=${pageRelease.totalPageNum}">末页</a>
				</div>
			</div>
			</div>
		</div>
