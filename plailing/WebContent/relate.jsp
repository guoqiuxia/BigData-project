...
<body>
	...
	<div class="subbox">
		...
		<div class="right840">
			<div class="title6">
				<h1>
					<a href="${ctx }/relate" class="on">课程更新</a>
				</h1>
				<h1>
			...
			<div class="display">				
				<c:forEach var="informAll" items="${listInformAll}">
					<c:forEach var="inform" items="${informAll.key}">
						<div>
							<p>
								<a href="${ctx}/courseDetail?courseId=${inform.course.courseId}"><span style="color: #333; font-size: 16px;">${inform.informText}</span></a>
							</p>
						</div>
					</c:forEach>
				</c:forEach>
			...
			<div class="pagination-container pagemiddle">
					<span class="wordstyle disabled">共${pageInform.totalPageNum}页</span>&nbsp;&nbsp;&nbsp;
					<a class="wordstyle disabled" href="relate?pageNum=1">首页</a> &nbsp;&nbsp;&nbsp;<a class="wordstyle disabled"
						href="relate?pageNum=${pageInform.prePageNum }">上一页</a>&nbsp;&nbsp;&nbsp; <a class="wordstyle disabled"
						href="relate?pageNum=${pageInform.nextPageNum }">下一页</a> &nbsp;&nbsp;&nbsp;<a class="wordstyle disabled"
						href="relate?pageNum=${pageInform. totalPageNum}">末页</a>
				</div>
			</div>
		</div>
	</div>
